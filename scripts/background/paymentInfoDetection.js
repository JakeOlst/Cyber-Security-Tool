...
/*
const ukCreditCardRegex = /^(?: 
    4[0-9]{12}(?:[0-9]{3})? |                 // Visa
    5[1-5][0-9]{14} |                          // MasterCard
    3[47][0-9]{13} |                           // American Express
    (?:6011|65[0-9]{2}|64[4-9]|62212[6-9]|     // Discover
      6221[3-9][0-9]|622[2-8][0-9]{2}|6229[01])-[0-9]{10} | 
    (?:5[0678]\d\d|6304|6390|67\d\d)\d{8,15} | // Maestro
    (?:5018|5020|5038|6304|6759|6761|6763)[0-9]{8,15} | // Maestro
    (?:50[0-9]{4}|65[0-9]{2})\d{8,12}         // Diners Club
)$/;  
*/
